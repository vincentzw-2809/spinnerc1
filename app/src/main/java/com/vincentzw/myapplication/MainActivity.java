package com.vincentzw.myapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void  initSpinner2() {
        List<String> pelakuList = new ArrayList<>();

        for (int i = 1; i <=1000; i++) {
            pelakuList.add("Pelaku ke-" + i);
        }

        ArrayAdapter<String> arrayAdapter2 = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,pelakuList);
